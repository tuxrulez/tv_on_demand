...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Structure.chain'
        db.add_column('tv_on_demand_structure', 'chain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Chain'], null=True, blank=True), keep_default=False)

        # Adding field 'Structure.store'
        db.add_column('tv_on_demand_structure', 'store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Store'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Structure.chain'
        db.delete_column('tv_on_demand_structure', 'chain_id')

        # Deleting field 'Structure.store'
        db.delete_column('tv_on_demand_structure', 'store_id')
