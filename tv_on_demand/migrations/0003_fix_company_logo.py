...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Skin.company_logo'
        db.alter_column('tv_on_demand_skin', 'company_logo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Skin.company_logo'
        db.alter_column('tv_on_demand_skin', 'company_logo', self.gf('django.db.models.fields.files.FileField')(max_length=15, null=True))
    ...
    models = {
        ...
        'tv_on_demand.skin': {
            ...
            'company_logo': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'css_style': ('django.db.models.fields.files.FileField', [], {'max_length': '150'}),
