...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field groups on 'StructureRow'
        db.create_table('tv_on_demand_structurerow_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('structurerow', models.ForeignKey(orm['tv_on_demand.structurerow'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('tv_on_demand_structurerow_groups', ['structurerow_id', 'group_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field groups on 'StructureRow'
        db.delete_table('tv_on_demand_structurerow_groups')
