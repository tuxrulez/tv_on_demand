...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Structure.mediadatabase'
        db.add_column('tv_on_demand_structure', 'mediadatabase', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mediafiles.MediaDatabase']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Structure.mediadatabase'
        db.delete_column('tv_on_demand_structure', 'mediadatabase_id')
    ...
    models = {
        ...
        'mediafiles.mediafile': {
            ...
            'end_hour': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'media_database': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mediafiles.MediaDatabase']", 'null': 'True', 'blank': 'True'}),
            ...
            'start_hour': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
