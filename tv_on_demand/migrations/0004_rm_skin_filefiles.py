...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Skin.company_logo'
        db.delete_column('tv_on_demand_skin', 'company_logo')

        # Deleting field 'Skin.css_style'
        db.delete_column('tv_on_demand_skin', 'css_style')


    def backwards(self, orm):
        
        # Adding field 'Skin.company_logo'
        db.add_column('tv_on_demand_skin', 'company_logo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Skin.css_style'
        db.add_column('tv_on_demand_skin', 'css_style', self.gf('django.db.models.fields.files.FileField')(default='default_val', max_length=150), keep_default=False)
