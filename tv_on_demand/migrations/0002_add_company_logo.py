...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tv_on_demand_skin', 'company_logo', self.gf('django.db.models.fields.files.FileField')(max_length=15, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'tv_on_demand.skin': {
            ...
            'company_logo': ('django.db.models.fields.files.FileField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
